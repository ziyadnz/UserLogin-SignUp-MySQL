...
class _LoginPageState extends State<LoginPage> {
  Future<UserModel> createUser(
    ...
    var url = Uri.parse('http://192.168.1.101/assigment3/loginuser.php/');
    print(mail);
    print("createuser work");
    print(password);
    ...
    if (response.statusCode == 200) {
      try {
        ...
        setState(() {
          ...
          print(role + " burasu login");
          StartPage().role = role.toString();
        });
        print(role);
        login = true;
      } catch (e) {
  ...
  Widget _emailPasswordWidget() {
    return Column(
      children: <Widget>[
        ...
        _entryField("Password", passwordcontroller, TextInputType.number,
            isPassword: true),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final subheight = kIsWeb ? height / 4 : 1.0;
    return Scaffold(
        body: Container(
      height: height,
      child: Stack(
        children: <Widget>[
          ...
          Container(
            ...
            child: SingleChildScrollView(
              child: Padding(
                padding: EdgeInsets.fromLTRB(subheight, 0, subheight, 0),
                child: Column(
